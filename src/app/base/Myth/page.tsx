...
export const metadata: Metadata = {
    title: "Myth - Knowledge Base | Developer Sujay",
};
...
export default function Myth() {
    const content = (
        <>
            <p>
                <Bold>Myth</Bold> is a genre of folklore consisting primarily of narratives that play a fundamental role in a society, such as foundational tales or origin myths. For scholars, this is very different from the vernacular usage of the term &quot;myth&quot; that simply refers to a belief that is not true. Instead, the truth value of a myth is not a defining criterion.
                <br />
                <br />
                Myths are often endorsed by secular and religious authorities and are closely linked to <Link slug="Religion" title="religion" /> or spirituality. Many societies group their myths, legends, and history together, considering myths and legends to be true accounts of their remote past. In particular, creation myths take place in a primordial age when the world had not achieved its later form. Other myths explain how a society&apos;s customs, institutions, and taboos were established and sanctified. There is a complex relationship between recital of myths and the enactment of rituals.
            </p>
            <ParagraphSecondaryHeader id="Etymology">Etymology</ParagraphSecondaryHeader>
            <span id="Etymology"></span>
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/Francesco_Hayez_028.jpg/375px-Francesco_Hayez_028.jpg" w={400} h={350} caption={
                (
                    <>
                        <i>Odysseus Overcome by Demodocus&apos; Song</i>, by Francesco Hayez, 1813–1815
                    </>
                )
            } />
            <br />
            <p>
                The word &quot;myth&quot; comes from Ancient Greek μῦθος (<i>mȳthos</i>), meaning &apos;speech, narrative, fiction, myth, plot&apos;. In turn, Ancient Greek μυθολογία (<i>mythología</i>, &apos;story&apos;, &apos;lore&apos;, &apos;legends&apos;, or &apos;the telling of stories&apos;) combines the word <i>mȳthos</i> with the suffix <i>-λογία</i> (<i>-logia</i>, &apos;study&apos;) in order to mean &apos;romance, fiction, story-telling.&apos; Accordingly, Plato used <i>mythología</i> as a general term for &apos;fiction&apos; or &apos;story-telling&apos; of any kind. In Anglicised form, this Greek word began to be used in English (and was likewise adapted into other European languages) in the early 19th century, in a much narrower sense, as a scholarly term for &quot;[a] traditional story, especially one concerning the early history of a people or explaining a natural or social phenomenon, and typically involving supernatural beings or events&quot;.
                <br />
                <br />
                The Greek term <i>mythología</i> was then borrowed into Late Latin, occurring in the title of Latin author Fulgentius&apos; 5th-century <i>Mythologiæ</i> to denote what we now call <i>classical mythology</i>—i.e., Greco-Roman etiological stories involving their gods. Fulgentius&apos; <i>Mythologiæ</i> explicitly treated its subject matter as allegories requiring interpretation and not as true events. The Latin term was then adopted in Middle French as <i>mythologie</i>. Whether from French or Latin usage, English adopted the word &quot;mythology&quot; in the 15th century, initially meaning &apos;the exposition of a myth or myths&apos;, &apos;the interpretation of fables&apos;, or &apos;a book of such expositions&apos;. The word is first attested in John Lydgate&apos;s <i>Troy Book</i> (c. 1425).
                <br />
                <br />
                From Lydgate until the 17th or 18th century, &quot;mythology&quot; meant a moral, fable, allegory or a parable, or collection of traditional stories, understood to be false. It came eventually to be applied to similar bodies of traditional stories among other polytheistic cultures around the world. Thus &quot;mythology&quot; entered the English language before &quot;myth&quot;. Johnson&apos;s <i>Dictionary</i>, for example, has an entry for mythology, but not for myth. Indeed, the Greek loanword <i>mythos</i> (pl. <i>mythoi</i>) and Latinate <i>mythus</i> (pl. <i>mythi</i>) both appeared in English before the first example of &quot;myth&quot; in 1830.
            </p>
            <ParagraphSecondaryHeader id="Protagonists_and_structure">Protagonists and structure</ParagraphSecondaryHeader>
            <p id="Protagonists_and_structure">
            ...
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Hotherus_and_wood_maidens_by_Froelich.jpg/330px-Hotherus_and_wood_maidens_by_Froelich.jpg" w={350} h={300} caption={
                (
                    <>
            ...
            <BlockQuote>Myth, a story of the gods, a religious account of the beginning of the world, the creation, fundamental events, the exemplary deeds of the gods as a result of which the world, nature and culture were created together with all parts thereof and given their order, which still obtains. A myth expresses and confirms society&apos;s religious values and norms, it provides a pattern of behavior to be imitated, testifies to the efficacy of ritual with its practical ends and establishes the sanctity of cult.</BlockQuote>
            <p>
            ...
            <br />
            <SubTitle>Related terms</SubTitle>
            <span id="Mythology"></span>
            <SecondarySubTitle>Mythology</SecondarySubTitle>
            <br />
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Jesus-College-MS-111_00379_190r_%28cropped%29_Geraint.jpg/440px-Jesus-College-MS-111_00379_190r_%28cropped%29_Geraint.jpg" w={400} h={450} caption={
                (
                    <>
                        ...
                        <i>Gereint vab Erbin. Arthur a deuodes dala llys yg Caerllion ar Wysc...</i>
            ...
            <br />
            <SecondarySubTitle>Mythography</SecondarySubTitle>
            <br />
            <p>
            ...
            <div className="pl-4">
                <ul className="pl-4 list-disc">
                    ...
                    <br />
                    <li>
                        Fabius Planciades Fulgentius, a Latin writer of the late-5th to early-6th centuries, whose <i>Mythologies</i> (Latin: <i>Mitologiarum libri III</i>) gathered and gave moralistic interpretations of a wide range of myths;
                    </li>
                    <br />
                    <li>
                    ...
                    <br />
                    <li>
                        Renaissance scholar Natalis Comes, whose ten-book <i>Mythologiae</i> became a standard source for classical mythology in later Renaissance Europe.
                    </li>
                </ul>
            </div>
            <br />
            <p>
                Other prominent mythographies include the thirteenth-century <i>Prose Edda</i> attributed to the Icelander Snorri Sturluson, which is the main surviving survey of Norse Mythology from the Middle Ages.
                <br />
                <br />
                Jeffrey G. Snodgrass (professor of anthropology at the Colorado State University) has termed India&apos;s <i>Bhats</i> (<i>Bhāt</i>) as mythographers.
            </p>
            <br />
            <SecondarySubTitle>Myth Criticism</SecondarySubTitle>
            <br />
            <p>
            ...
            <br />
            <SecondarySubTitle>Cultural myth criticism</SecondarySubTitle>
            <br />
            <p>
            ...
            <BlockQuote>Myth criticism, a discipline that studies myths (mythology contains them, like a pantheon its statues), is by nature interdisciplinary: it combines the contributions of literary theory, the history of literature, the fine arts and the new ways of dissemination in the age of communication. Likewise, it undertakes its object of study from its interrelation with other human and social sciences, in particular sociology, anthropology and economics. The need for an approach, for a methodology that allows us to understand the complexity of the myth and its manifestations in contemporary times, is justified.</BlockQuote>
            <SecondarySubTitle>Mythos</SecondarySubTitle>
            <br />
            <p>
            ...
            <br />
            <SecondarySubTitle>Mythopoeia</SecondarySubTitle>
            <br />
            <p>
                <i>Mythopoeia</i> (<i>mytho-</i> + <i>-poeia</i>, &apos;I make myth&apos;) was termed by J. R. R. Tolkien, amongst others, to refer to the &quot;conscious generation&quot; of mythology. It was notoriously also suggested, separately, by Nazi ideologist Alfred Rosenberg.
            </p>
            <ParagraphSecondaryHeader id="Interpretations">Interpretations</ParagraphSecondaryHeader>
            <span id="Interpretations"></span>
            <SubTitle>Comparative mythology</SubTitle>
            <p>
            ...
            <br />
            <SubTitle>Functionalism</SubTitle>
            <p>
                ...
                <br />
                <br />
                Devdutt Pattanaik defines mythology as &quot;the subjective truth of people communicated through stories, symbols and rituals.&quot;. He says, &quot;Facts are everybody&apos;s truth. Fiction is nobody&apos;s truth. Myths are somebody&apos;s truth.&quot;.
            </p>
            <br />
            <SubTitle>Euhemerism</SubTitle>
            <p>
                One theory claims that myths are distorted accounts of historical events. According to this theory, storytellers repeatedly elaborate upon historical accounts until the figures in those accounts gain the status of gods. For example, the myth of the wind-god Aeolus may have evolved from a historical account of a king who taught his people to use sails and interpret the winds. Herodotus (fifth-century BCE) and Prodicus made claims of this kind. This theory is named <i>euhemerism</i> after mythologist Euhemerus (c. 320 BCE), who suggested that Greek gods developed from legends about humans.
            </p>
            <br />
            <SubTitle>Allegory</SubTitle>
            <p>
            ...
            <br />
            <SubTitle>Personification</SubTitle>
            <p>
            ...
            <br />
            <SubTitle>Ancient Greece</SubTitle>
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Myths_and_legends_of_Babylonia_and_Assyria_%281916%29_%2814801987593%29.jpg/255px-Myths_and_legends_of_Babylonia_and_Assyria_%281916%29_%2814801987593%29.jpg" w={250} h={500} caption={
                (
                    <>
                        <i>Myths and legends of Babylonia and Assyria</i> (1916)
                    </>
                )
            } />
            <br />
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Editions_of_Hamilton%27s_book.png/440px-Editions_of_Hamilton%27s_book.png" w={450} h={400} caption={
                (
                    <>
                        Edith Hamilton&apos;s <i>Mythology</i> has been a major channel for English speakers to learn classical Greek and Roman mythology
                    </>
                )
            } />
            <br />
            ...
            <br />
            <p>
                Plato condemned poetic myth when discussing education in the <i>Republic</i>. His critique was primarily on the grounds that the uneducated might take the stories of gods and heroes literally. Nevertheless, he constantly referred to myths throughout his writings. As Platonism developed in the phases commonly called Middle Platonism and neoplatonism, writers such as Plutarch, Porphyry, Proclus, Olympiodorus, and Damascius wrote explicitly about the symbolic interpretation of traditional and Orphic myths.
                <br />
                <br />
                Mythological themes were consciously employed in literature, beginning with Homer. The resulting work may expressly refer to a mythological background without itself becoming part of a body of myths (Cupid and Psyche). Medieval romance in particular plays with this process of turning myth into literature. <i>Euhemerism</i>, as stated earlier, refers to the rationalization of myths, putting themes formerly imbued with mythological qualities into pragmatic contexts. An example of this would be following a cultural or religious paradigm shift (notably the re-interpretation of pagan mythology following Christianization).
            </p>
            <br />
            <SubTitle>European Renaissance</SubTitle>
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Bartolomeo_di_Giovanni_-_The_Myth_of_Io_-_Walters_37421.jpg/600px-Bartolomeo_di_Giovanni_-_The_Myth_of_Io_-_Walters_37421.jpg" w={400} h={250} caption={
                (
                    <>
                        This panel by Bartolomeo di Giovanni relates the second half of the <i>Metamorphoses</i>. In the upper left, Jupiter emerges from clouds to order Mercury to rescue Io.
                    </>
                )
            } />
            <br />
            <p>
                Interest in polytheistic mythology revived during the Renaissance, with early works of mythography appearing in the sixteenth century, among them the <i>Theologia Mythologica</i> (1532).
            </p>
            <br />
            <SubTitle>19th century</SubTitle>
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Robert_Wilhelm_Ekman_-_V%C3%A4in%C3%A4m%C3%B6inen%E2%80%99s_Play.jpg/340px-Robert_Wilhelm_Ekman_-_V%C3%A4in%C3%A4m%C3%B6inen%E2%80%99s_Play.jpg" w={250} h={450} caption={
                (
                    <>
                        Väinämöinen, the wise demigod and one of the significant characters of Finnish mythological 19th-century epic poetry, <i>The Kalevala</i> <span className="italic font-extralight">(Väinämöinen&apos;s Play, Robert Wilhelm Ekman, 1866)</span>
                    </>
                )
            } />
            <br />
            <p>
                The first modern, Western scholarly theories of myth appeared during the second half of the 19th century—at the same time as &quot;myth&quot; was adopted as a scholarly term in European languages. They were driven partly by a new interest in Europe&apos;s ancient past and vernacular culture, associated with Romantic Nationalism and epitomised by the research of Jacob Grimm (1785–1863). This movement drew European scholars&apos; attention not only to Classical myths, but also material now associated with Norse mythology, Finnish mythology, and so forth. Western theories were also partly driven by Europeans&apos; efforts to comprehend and control the cultures, stories and religions they were encountering through colonialism. These encounters included both extremely old texts such as the Sanskrit <i>Rigveda</i> and the Sumerian <i>Epic of Gilgamesh</i>, and current oral narratives such as mythologies of the indigenous peoples of the Americas or stories told in traditional African religions.
                <br />
                <br />
            ...
            <br />
            <SecondarySubTitle>Nature</SecondarySubTitle>
            <br />
            <p>
                One of the dominant mythological theories of the latter 19th century was <i>nature mythology</i>, the foremost exponents of which included Max Müller and Edward Burnett Tylor. This theory posited that &quot;primitive man&quot; was primarily concerned with the natural world. It tended to interpret myths that seemed distasteful to European Victorians—such as tales about sex, incest, or cannibalism—as metaphors for natural phenomena like agricultural fertility. Unable to conceive impersonal natural laws, early humans tried to explain natural phenomena by attributing souls to inanimate objects, thus giving rise to animism.
                <br />
                <br />
            ...
            <br />
            <SecondarySubTitle>Ritual</SecondarySubTitle>
            <br />
            <p>
            ...
            <br />
            <SubTitle>20th century</SubTitle>
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Prometheus_by_Gustave_Moreau.jpg/340px-Prometheus_by_Gustave_Moreau.jpg" w={300} h={450} caption={
                (
                    <>
                        <i>Prometheus</i> (1868) by Gustave Moreau. In the mythos of Hesiodus and possibly Aeschylus (the Greek trilogy <i>Prometheus Bound</i>, <i>Prometheus Unbound</i> and <i>Prometheus Pyrphoros</i>), Prometheus is bound and tortured for giving fire to humanity.
                    </>
                )
            } />
            <br />
            <p>
                The earlier 20th century saw major work developing psychoanalytical approaches to interpreting myth, led by Sigmund Freud, who, drawing inspiration from Classical myth, began developing the concept of the Oedipus complex in his 1899 <i>The Interpretation of Dreams</i>. Jung likewise tried to understand the psychology behind world myths. Jung asserted that all humans share certain innate unconscious psychological forces, which he called <i>archetypes</i>. He believed similarities between the myths of different cultures reveals the existence of these universal archetypes.
                <br />
                <br />
            ...
            <p>
                ...
                <br />
                <br />
                Correspondingly, scholars challenged the precedence that had once been given to texts as a medium for mythology, arguing that other media, such as the visual arts or even landscape and place-naming, could be as or more important. Myths are not texts, but <i>narrative materials</i> (<i>Erzählstoffe</i>) that can be adapted in various media (such as epics, hymns, handbooks, movies, dances, etc.). In contrast to other academic approaches, which primarily focus on the (social) function of myths, <i>hylistic myth research</i> aims to understand myths and their nature out of themselves. As part of the Göttingen myth research, Annette and Christian Zgoll developed the method of hylistics (narrative material research) to extract mythical materials from their media and make possible a transmedial comparison. The content of the medium is broken down into the smallest possible plot components (<i>hylemes</i>), which are listed in standardized form (so-called <i>hyleme analysis</i>). Inconsistencies in content can indicate stratification, i.e. the overlapping of several materials, narrative variants and edition layers within the same medial concretion.  To a certain extent, this can also be used to reconstruct earlier and alternative variants of the same material that were in competition and/or were combined with each other. The juxtaposition of hyleme sequences enables the systematic comparison of different variants of the same material or several different materials that are related or structurally similar to each other. In his overall presentation of the hundred-year history of myth research, the classical philologist and myth researcher Udo Reinhardt mentions Christian Zgoll&apos;s basic work <i>Tractatus mythologicus</i> as &quot;the latest handbook on myth theory&quot; with &quot;outstanding significance&quot; for modern myth research.
            </p>
            <ParagraphSecondaryHeader id="Modernity">Modernity</ParagraphSecondaryHeader>
            <span id="Modernity"></span>
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/10%2C000_Belgian_francs_of_1929_%28cropped%29.jpg/330px-10%2C000_Belgian_francs_of_1929_%28cropped%29.jpg" w={450} h={200} caption={
                (
                    <>
            ...
            <p>
                ...
                <br />
                <br />
                21st-century films such as <i>Clash of the </i>Titans, <i>Immortals</i> and <i>Thor</i> continue the trend of using traditional mythology to frame modern plots. Authors use mythology as a basis for their books, such as Rick Riordan, whose Percy Jackson and the Olympians series is situated in a modern-day world where the Greek deities are manifest.
                <br />
                <br />
    ...
    return (
        <>
            <Layout topic="Mythology" title="Myth" thumbnail="/assets/mythology.png" content={content} />
        </>
    );
};