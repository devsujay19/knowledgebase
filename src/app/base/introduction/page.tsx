    ...
    const content = (
        <>
            <p>
                ...
                } />. As you go deeper in the base page, you&apos;ll see that I&apos;m pretty much interested in <Link slug="Mythology" title="Mythology" />,<Link slug="Religion" title="Religions" /> and many things related to those. I wrote all of the articles with data from either a book or from <Link slug="Internet" title="Internet" />. This platform doesn&apos;t only include stuffs about development and coding, but includes about <Link slug={"Biology"} title="Biology" />, <Link slug={"Chemistry"} title="Chemistry" /> and <Redirect href="/base" text="more" />...
            </p>
            <Divider />
